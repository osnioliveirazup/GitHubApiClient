...
namespace GitHubApi.Repositories.Models
{
    ...
    public partial class GetRepositoriesForUserResponse
    {
        public static List<GetRepositoriesForUserResponse> FromJson(string json)
            => JsonConvert.DeserializeObject<List<GetRepositoriesForUserResponse>>(json, GitHubApi.Repositories.Models.Settings.Converter.Settings);
    }
}
